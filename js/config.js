...
export const BADGES = [
  ...
  { id: "supplier_first", icon: "🤝", name: "Premier contact", desc: "1er fournisseur créé", cat: "fournisseurs", ok: s => s.supAdded >= 1 },
  { id: "sup5", icon: "🗂️", name: "Réseau solide", desc: "5 fournisseurs créés", cat: "fournisseurs", ok: s => s.supAdded >= 5 },
  { id: "sup10", icon: "🌐", name: "Ambassadeur", desc: "10 fournisseurs créés", cat: "fournisseurs", ok: s => s.supAdded >= 10 },
  ...
  { id: "legend", icon: "🌌", name: "Galaxie", desc: "Tous les autres badges débloqués", cat: "social", ok: s => s.badges && s.badges.length >= 41 },
];
